...
@NamedQueries({ @NamedQuery(name = "BatchDetails.findAll", query = "SELECT b FROM BatchDetails b"),
...
public class BatchDetails implements Serializable {
	...
	public BatchDetails(Integer id, String fileNumber, int fileStatus, String createdBy, Date createDate,
			byte[] rowVersion, int numberOfImages, int numberOfPages) {
		this.id = id;
